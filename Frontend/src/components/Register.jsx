...
function Register() {
    ...
    return (
        <div class="h-screen flex items-center justify-center bg-principal">

            <div class="flex rounded-xl border px-12  bg-black bg-opacity-10" style={{ height: 400, width: 700 }}>
                ...
                <div class="flex min-h-full flex-col justify-center pr-6 py-4 lg:px-10" style={{ width: 350 }}>
                    ...
                    <div class="sm:mx-auto sm:w-full sm:max-w-sm ">
                        ...
                        <p class="mt-7 mb-7 text-center text-sm text-gray-50">
                            Ya tienes cuenta?
                            <a href="#" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500" onClick={irLogin}> Iniciar sesion</a>
                        </p>
                    </div>
                </div>
